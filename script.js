...
var initial = setInterval(() => {
  if (i > 0) {
    txtBox.innerText = `Please wait ${i} seconds Bebuu ...!`;
    i--
  }
  else if(i == 0) {
...
function startTyping() {
  ...
  var txt1 =
    ...
    "Hi Hinuuu.....!  <<               On this special day, I want to say something special to you. <<<                So , Please read everything carefully...!                                                                           > When I saw you for the first time < You seems something Special to me.  <<                  As the years goes < you get closer to me....! <<                           I don't know the reason why your thoughts always resonates inside my mind...!                                                     > Everything about you is always intresting for me...!                     << I am somewhat nervous  Because I don't know whether you'll accept my proposal or not <<< but still I want to propose you in best way I ever could with all your conditions....!  > Today, I want to take our relationship to a new level. I want to promise you forever. << I want to wake up every morning knowing that I get to spend the rest of my life by your side, supporting you, loving you, and building a future together.                                                    >  So, Hinuuu ...! << 'Will you marry me...??' <<  Will you be my partner in all things, my confidante, my best friend, and my love for all eternity?         Now You are the only person  whom I love equally with my parents....! << I can't wait to start this journey with you, << 🥰🥰🥰🥰 << hand in hand, and create a lifetime of beautiful memories together.   >  I Love You < My SweetHeart.....! 💖💖         << Give me One chance to Prove my Love ...! << Your Jem 🌹";
  var speed = 100;
  typeWriter();
  function typeWriter() {
    if (i < txt1.length) {
      ...
      } else txtBox.innerHTML += txt1.charAt(i);
      i++;
      setTimeout(typeWriter, speed);
    } else {
      document.querySelector(".propose-img-container").classList.add("show");
    }
  }
}
